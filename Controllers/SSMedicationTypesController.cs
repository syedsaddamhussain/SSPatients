...
{
    public class SSMedicationTypesController : Controller
    {
        private readonly PatientsContext _context;

        public SSMedicationTypesController(PatientsContext context)
        {
            _context = context;
        }

        // GET: SSMedicationTypes
        public async Task<IActionResult> Index()
        {
              return View(await _context.MedicationTypes.ToListAsync());
        }

        // GET: SSMedicationTypes/Details/5
        ...
        // GET: SSMedicationTypes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: SSMedicationTypes/Create
        ...
        // GET: SSMedicationTypes/Delete/5
        ...
        // POST: SSMedicationTypes/Delete/5
