...
{
    public class SSCountriesController : Controller
    {
        private readonly PatientsContext _context;

        public SSCountriesController(PatientsContext context)
        {
            _context = context;
        }
        ...
        // GET: SSCountries/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: SSCountries/Create
